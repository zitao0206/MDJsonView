...
@interface MDJsonBaseView ()
@property (nonatomic, strong) MDJsonViewModel *model;
@property (nonatomic, strong) MDJsonNotificationManager *manager;
@end

@implementation MDJsonBaseView
- (id)initWithFrame:(CGRect)frame
{
    self = [super initWithFrame:frame];
    if (self) {
        _manager = [MDJsonNotificationManager new];
    }
    return self;
}
